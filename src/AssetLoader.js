...
export async function loadAssets(levelPkg, tuningDoc) {
  ...
  const playerImg = await loadImageAsync("assets/bearSpriteSheet.png");
  const boarImg = await loadImageAsync("assets/bunnySpriteSheet.png");
  const leafImg = await loadImageAsync("assets/bananaSpriteSheet.png");
...
async function loadBackgrounds(levelPkg) {
  ...
  return {
    bgFar: await loadImageAsync("assets/background1.png"),
    bgMid: await loadImageAsync("assets/background2.png"),
    bgFore: await loadImageAsync("assets/background3.png"),
  };
}
